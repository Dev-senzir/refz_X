...
@IC_X_K.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular IC_X_K",
    },
)
...
@IC_X_K.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي CatIC_X_K is One of the Popular IC_X_K",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@IC_X_K.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular IC_X_K",
    },
)
async def nekobot(cat):
...
@IC_X_K.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular IC_X_K",
    },
)
async def nekobot(cat):
