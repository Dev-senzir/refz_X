...
@IC_X_K .ar_cmd(pattern="ملصق(?:\s|$)([\s\S]*)")
async def kang(args):
    photo = None
    emojibypass = False
    is_anim = False
...
@IC_X_K .ar_cmd(pattern="حزمة(?:\s|$)([\s\S]*)")
...
@IC_X_K .ar_cmd(pattern="تحويل بملصق(?:\s|$)([\s\S]*)")
...
@IC_X_K .ar_cmd(pattern="معلومات_ألملصق$")
