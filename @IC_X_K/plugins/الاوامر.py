...
@IC_X_K.ar_cmd(pattern="م15")
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𝗧𝗟𝗘𝗧𝗛𝗢𝗡 𝗥𝗘𝗙𝗭 ⦔ ♢━⊶⌯⩺\n\nاوامر جلب الذاتية وامر الاضافة**:\n\n ◂  `.ضيف`\n❃ اكتب الامر مع رابط مجموعه التي تريد سحب اعضائها وارسل الامر في مجموعتك لسحبهم الى مجموعتك\n\n ◂ `.ذاتيه` او `.ذاتية`\n❃ بالرد على صورة او فيديو ذاتية التدمير لحفظها وارسالها في الرسائل المحفوظة بسرية تامة الامر ل ريفز حصريا!\n⩹⌯⊷━♢ ⦓ 𝗧𝗟𝗘𝗧𝗛𝗢𝗡 𝗥𝗘𝗙𝗭 ⦔ ♢━⊶⌯⩺",
    )


@IC_X_K.ar_cmd(pattern="م16")
async def hi(event):
    await edit_or_reply(
        event,
...
@IC_X_K.ar_cmd(pattern="م21")
async def we(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𝗧𝗟𝗘𝗧𝗛𝗢𝗡 𝗥𝗘𝗙𝗭 ⦔ ♢━⊶⌯⩺\n\n• اوامر التحكم تتيح لمستخدم اخر ان يستخدم اوامر تنصيبك وهو غير منصب ريفز حيث سيصبح متحكم في اوامر تنصيبك يرجى الانتباه من انه سيحصل على صلاحيات الاوامر وقد يسبب خطورة لك اذا كنت لا تثق في المستخدم الذي اضفته. \n\n\n`.التحكم` تفعيل/تعطيل\n• تستخدم هذه الميزة لتفعيل/لتعطيل خاصية التحكم بأوامر تنصيبك للمستخدمين الذين أضفتهم في قائمة المتحكمين\n\n`.المتحكمين`\n• لعرض المستخدمين الذين اضفتهم الى قائمة المستخدمين المتحكمين\n\n`.اضف متحكم`\n• بالرد على المستخدم لأضافته متحكم في تنصيب ريفز الخاص بك\n\n`.ازالة متحكم`\n• بالرد على المستخدم لازالته من قائمة المتحكمين\n⩹⌯⊷━♢ ⦓ 𝗧𝗟𝗘??𝗛𝗢𝗡 𝗥𝗘𝗙𝗭 ⦔ ♢━⊶⌯⩺\n**⌯︙ [┈┉━｢ 𝗧𝗟𝗘𝗧𝗛𝗢𝗡 𝗥𝗘𝗙𝗭 🕷 ｣━┅┈](t.me/def_Zoka)**",
        link_preview=False,
    )


@IC_X_K.ar_cmd(pattern="م22")
async def ae(event):
    await edit_or_reply(
        event,
