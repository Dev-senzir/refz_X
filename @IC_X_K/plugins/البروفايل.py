...
@IC_X_K.ar_cmd(pattern="وضع بايو ([\s\S]*)")
async def _(event):
...
@IC_X_K.ar_cmd(pattern="وضع اسم ([\s\S]*)")
async def _(event):
...
@IC_X_K.ar_cmd(pattern="وضع صورة$")
async def _(event):
...
@IC_X_K.ar_cmd(pattern="وضع يوزر ([\s\S]*)")
...
@IC_X_K.ar_cmd(pattern="ازالة الصورة ?([\s\S]*)")
