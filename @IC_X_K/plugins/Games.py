...
@IC_X_K.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@IC_X_K.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** مطور السورس **⪼ [𝐘𝐎𝐔𝐒𝐄𝐅᪣ ⌁ 🕷](t.me/IC_X_K)   \n"
    "**-** قناة السورس **⪼ [𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐄𝐅𝐙](t.me/def_Zoka)   "
]

@IC_X_K.on(admin_cmd(pattern="الالعاب$"))
...
@IC_X_K.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@IC_X_K.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
@IC_X_K.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_5erok))

    
@IC_X_K.on(admin_cmd(pattern="اذكار عشر$"))    
...
@IC_X_K.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@IC_X_K.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
