...
async def _ban_person(event):
    ...
    if user.id == 6301863282:
        return await edit_delete(event, "**- لا يمكنك حظر مطور السورس يوسف****")
...
@IC_X_K.ar_cmd(pattern="كتم(?:\s|$)([\s\S]*)")
...
@IC_X_K.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@IC_X_K.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
