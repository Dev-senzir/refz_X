...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            ...
            caption=f"**🎆┊حـالات واتـس قصيـرة 🧸♥️**\n\n[➧᥉᥆υᖇᥴᥱ 𝐑𝐄𝐅𝐙](https://t.me/def_Zoka)",
        )
...
IC_X_K.ar_cmd(pattern="ستوري انمي$")
async def _(event):
...
@IC_X_K.ar_cmd(pattern="ولد انمي$")
async def _(event):
...
@IC_X_K.ar_cmd(pattern="بنت انمي$")
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ - جـارِ تحميـل الآفتـار ...𓅫╰**")
    try:
        zedph = [
