...
from . import edit_delete, edit_or_reply, IC_X_K, progress
...
@IC_X_K.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@IC_X_K.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@IC_X_K.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@IC_X_K.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
