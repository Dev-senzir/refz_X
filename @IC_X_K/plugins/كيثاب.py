...
@IC_X_K.ar_cmd(
    ...
    info={
        "header": "Source code link of IC_X_K",
        "usage": [
            "{tr}repo",
        ],
    },
...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "اضغط [هنا](t.me/def_Zoka) لفتح قناة السورس\
        \nاضغط [هنا](t.me/rev_fxx) جروب الدعم",
    )
...
@IC_X_K.ar_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in **IC_X_K/plugins** folder\
...
async def git_commit(file_name, mone):
    ...
    if create_file:
        file_name = f"IC_X_K/plugins/{file_name}"
        LOGS.info(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your PLUGINS](https://github.com/{ccess}/tree/master/IC_X_K/plugins/)"
            )
