...
from IC_X_K import StartTime, jmthonversion, IC_X_K
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**سورس ريفز يعمل بنجاح**"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        query = event.text
        await IC_X_K.get_me()
        if query.startswith("السورس") and event.query.user_id == IC_X_K.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/def_Zoja"),
                    Button.url("مطور السورس 👨🏼‍💻", "https://t.me/IC_X_K"),
                ]
            ]
