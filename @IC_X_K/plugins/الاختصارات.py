#السورس مربوط باستضافتي تخمط تبلع انت وسورسك المبرمج يوسف يكسختك#@IC_X_K
from IC_X_K import IC_X_K

from ..core.managers import edit_or_reply
@IC_X_K.on(admin_cmd(pattern="رموز1(?:\s|$)([\s\S]*)"))
...
❶❷❸❹❺❻❼❽❾⓿
⓫⓬⓭⓮⓯⓰⓱⓲⓳⓴ `""")
@IC_X_K.on(admin_cmd(pattern="رموز2(?:\s|$)([\s\S]*)"))
async def permalink(mention):
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎ `""")   
@IC_X_K.on(admin_cmd(pattern="تمبلريه(?: |$)(.*)"))
async def iq(event):
     await edit_or_reply(event, "⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺\n**⎈ ⦙  قائـمه اوامر الزغرفه :** \n⎈ ⦙  `.المواليد ` \n⎈ ⦙  `.اشهر مزغرفه` \n⎈ ⦙  `.الاختصارات` \n⎈ ⦙  `.البايو` \n⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺",)    
@IC_X_K.on(admin_cmd(pattern="البايو(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**⎈ ⦙  - 𝑩𝑰𝑶 𝑳𝑰𝑺𝑻 : **\n⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺\n**⎈ ⦙ قائـمه البايو :** \n⎈ ⦙  `.بايو1 ` \n⎈ ⦙  `.بايو2` \n⎈ ⦙  `.بايو3 ` \n⎈ ⦙  `.بايو4 ` \n⎈ ⦙  `.بايو5` \n⎈ ⦙ لجلب بايو عشوائي اكتب ◂ `.بايو`\n⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺")
@IC_X_K.on(admin_cmd(pattern="الزغرفة(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**⎈ ⦙  - آلَٰـُـٰٓزغَٰـُـٰٓرفَٰ͒ـُـٰٓة 𖠨 : **\n⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺\n**⎈ ⦙  قائـمه الزغرفة :** \n⎈ ⦙  `.زغرفة1 ` \n⎈ ⦙  `.زغرفة2` \n⎈ ⦙  `.زغرفة3 ` \n⎈ ⦙  `.زغرفة4 ` \n⎈ ⦙  `.زغرفة5` \n ⎈ ⦙  `.زغرفة6`\n ⎈ ⦙  `.زغرفة7`\n ⎈ ⦙  `.زغرفة8`\n ⎈ ⦙  `.زغرفة9`\n⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺")
@IC_X_K.on(admin_cmd(pattern="الاختصارات(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**⎈ ⦙  - 𝑺𝑯𝑶𝑹𝑻𝑪𝑼𝑻𝑺 : **\⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺\n**⎈ ⦙  قائـمه الاختصارات :** \n⎈ ⦙  `.اختصارات1 ` \n⎈ ⦙  `.اختصارات2` \n⎈ ⦙  `.اختصارات3 ` \n⎈ ⦙  `.اختصارات4 ` \n⎈ ⦙  `.اختصارات5` \n⩹⌯⊷━♢ ⦓𝐓𝐋𝐄𝐓𝐇𝐎𝐍 𝐑𝐄𝐅𝐙 ⦔ ♢━⊶⌯⩺")
@IC_X_K.on(admin_cmd(pattern="اشهر مزغرفه(?: |$)(.*)"))
async def _(event):
...
@IC_X_K.on(admin_cmd(pattern="المواليد(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "₁₉₉₅\n"
                "₁₉₉₆\n"
...
@IC_X_K.on(admin_cmd(pattern="اختصارات1(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "ڪݪخـرا .\n"
                "نجَبـيہ .\n"
...
@IC_X_K.on(admin_cmd(pattern="اختصارات2(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "ע\n"
                "ليـشـہٰ \n"
...
@IC_X_K.on(admin_cmd(pattern="اختصارات3(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "• ھھݪـﯠ\n"
                "• شلـﯛنڪہ\n"
...
@IC_X_K.on(admin_cmd(pattern="اختصارات4(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "؏ـليڪ\n"
                "أඋـبڪ\n"
...
@IC_X_K.on(admin_cmd(pattern="اختصارات5(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "- مٰنۅِ 💕.\n"
                "- شٰخصَ 💕.\n"
...
@IC_X_K.on(admin_cmd(pattern="بايو1(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "☁️ : 🕊\n" "☁️ :   ✨\n" "☁️ :   🤍\n\n" "بريئۃ ۿي، بصورۿ لطيفۃ ڪالاطفال🎀")
            
@IC_X_K.on(admin_cmd(pattern="بايو2(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "☘️ 💕\n" "☘️ 💕\n" "☘️ 💕\n" "☘️ دمت لي شيئاً جميلاً لا ينتهي💕")
            
@IC_X_K.on(admin_cmd(pattern="بايو3(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "𓋜┊𓆩 ➝  ˛⁽🇮🇶₎⇣ 𓆪\n"
                "𓋜┊𓆩  𓆪\n"
...
@IC_X_K.on(admin_cmd(pattern="بايو4(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "🜟 ↬ ᑎᗩᗰE ، • •😌❤️\n"
                "🜟 ↬ ᖴᖇOᗰ ، IRΔQ 🇮🇶\n"
...
@IC_X_K.on(admin_cmd(pattern="بايو5(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "𓂅| •\n" "𓂅| •\n" "𓂅| •🖤☁️ .\n" "• 𝙸 𝙻𝙸𝙺𝙴 𝙼𝙾𝚄𝙽𝚃𝙰𝙸𝙼𝚂 𝙽𝙾𝚃 𝙵𝙰𝙻𝙻 .")
@IC_X_K.on(admin_cmd(pattern="بايوهات1(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"""
— — — — — — — — —
`𓆦 : أيـۿ  ◡‌ 💙🧿.
...
— — — — — — — — —
""")
@IC_X_K.on(admin_cmd(pattern="بايوهات2(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"""
⠀⠀                
⠀ ⠀ ⠀⠀⠀`. ғʀᴏᴍ #𝙸𝚛𝚊𝚚 ↻.  
